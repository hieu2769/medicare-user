      ...
      <Box bg={"primary.main"} p={4} py={{ base: "4", md: "20" }}>
        <Box className="container">
          ...
          <Text
            ...
            color={"#fff"}
          >
            Khám phá đội ngũ đa chuyên khoa của <br />
      ...
      <div className="container">
        <Box>
          <Text
            ...
            fontWeight={500}
          >
            Trải nghiệm sự dễ dàng trong việc tìm kiếm chuyên gia y tế phù hợp <br /> với nhu cầu của bạn với danh sách bác sĩ toàn diện của chúng tôi.
          </Text>
