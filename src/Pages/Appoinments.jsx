    ...
    >
      <Flex align="center" gap={2} justify={"space-between"}>
        ...
        <Box flex={5}>
          ...
          <Box>
            ...
            <Text fontWeight="bold" fontSize={{ base: "sm", md: "md" }}>
              Tên: {appointment.patient_f_name} {appointment.patient_l_name},
              ID - #{appointment.id}
            </Text>
            <Text
              fontWeight="bold"
          ...
          <Text
            ...
            color={"gray.700"}
          >
            Bác sĩ: {appointment.doctor_f_name} {appointment.doctor_l_name}
          </Text>
          <Text
            fontWeight="bold"
            fontSize={{ base: "sm", md: "sm" }}
            color={"gray.700"}
          >
            Khoa: {appointment.department_name}
          </Text>
        </Box>
        ...
        <VStack align="end" spacing={1} flex={2}>
          ...
          >
            Đặt lại <Spacer mx={1} /> <AiOutlineArrowRight />
          </Button>
        </VStack>
      </Flex>
    </Box>
  ...
  const filterData = (appointments, filter) => {
    ...
    return appointments
      .filter((appointment) => {
        ...
        switch (filter) {
          case 1: // Tất cả
            return true; // Hiển thị tất cả lịch hẹn
          case 2: // Sắp tới
            return (
          ...
          <Box maxW={"100vw"} w={"700px"} minH={"80vh"} px={2}>
            {!data.length ? (
              <Box mt={5}>
                <Alert status="error">
                  <AlertIcon />
                  <AlertTitle>Bạn không có lịch hẹn nào.</AlertTitle>
                </Alert>
                <Button
                  mt={5}
                  colorScheme="blue"
