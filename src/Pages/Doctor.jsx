              ...
              <Box>
                ...
                <Flex justify={"space-between"} mt={1}>
                  ...
                  >
                    ...
                    <Text mt={-0.5}>
                      {data.total_appointment_done} Cuộc hẹn đã thực hiện
                    </Text>
                  </Text>
                </Flex>
              </Box>
            ...
            <Box>
              ...
              {data?.stop_booking === 1 || data.stop_booking === true ? (
                <Alert status="error" size={"xs"} py={1} px={1} mt={4}>
                  ...
                  <AlertTitle fontSize={"xs"}>
                    {" "}
                    Bác sĩ này không nhận lịch hẹn
                  </AlertTitle>
                </Alert>
              ) : null}
              ...
              data.clinic_stop_booking === true ? (
                <Alert status="error" size={"xs"} py={1} px={1} mt={4}>
                  ...
                  <AlertTitle fontSize={"xs"}>
                    {" "}
                    Phòng khám này không nhận lịch hẹn
                  </AlertTitle>
                </Alert>
              ) : null}
              <Button
                        ...
                        {feeData.map((fee) => (
                          ...
                          >
                            ...
                            <Text
                              ...
                              m={0}
                            >
                              {fee.id === 2 ? "Cuộc gọi video" : fee.title}
                            </Text>
                            <Text
                              mt={5}
                              fontSize={{ base: "12px", md: "13px" }}
