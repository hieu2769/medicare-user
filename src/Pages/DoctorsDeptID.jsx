      ...
      <Box mt={{ base: 0, md: 0 }} className="container" position={"relative"}>
        ...
        {!data.length ? (
          <>
            ...
            >
              Chúng tôi xin lỗi vì sự bất tiện này, nhưng hiện tại không có bác sĩ nào trong khoa{" "}
              <Text
                display={"inline-block"}
                fontWeight={600}
                color={"primary.text"}
              ...
              Vui lòng quay lại sau hoặc xem xét một khoa khác. Nếu bạn cần hỗ trợ ngay lập tức, đội ngũ hỗ trợ của chúng tôi sẵn sàng giúp bạn giải quyết mọi vấn đề khẩn cấp. Cảm ơn sự thông cảm và kiên nhẫn của bạn.
            </Text>
          </>
        ) : null}
        {error ? (
