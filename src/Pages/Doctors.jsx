    ...
    <Box>
      <Box bg={"primary.main"} p={4} py={{ base: "4", md: "20" }}>
        <Box className="container">
          ...
          <Text
            ...
            color={"#fff"}
          >
           Khám phá đội ngũ chuyên gia 
            <Text as={"span"} color={"green.text"} fontWeight={800}>
              {' '}chăm sóc sức khỏe đa năng
            </Text>
          </Text>
        </Box>
      </Box>{" "}
      ...
      >
        <Text
          ...
          fontWeight={500}
        >
          Trải nghiệm sự dễ dàng trong việc tìm kiếm chuyên gia y tế phù hợp <br />
          với nhu cầu của bạn với danh sách bác sĩ toàn diện của chúng tôi.
        </Text>
        <Flex
                        ...
                        <Box cursor={"pointer"} padding={5}>
                          ...
                          <Flex gap={{ base: 3, md: 5 }} align="center">
                            <Box
                              ...
                              border={item.image ? "4px solid #fff" : "none"}
                          ...
                          <Flex justify={"space-between"} mt={1}>
                            ...
                            >
                              ...
                              <Text mt={-0.5}>
                                {item.total_appointment_done} Lịch hẹn đã thực hiện
                              </Text>
                            </Text>
                          </Flex>
                          {item?.stop_booking === 1 && (
