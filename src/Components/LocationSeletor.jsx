...
const LocationSeletor = ({ type }) => {
  ...
  const fetchLocation = async () => {
    ...
    try {
      ...
      toast({
        title: "Không thể lấy được thành phố",
        description: "Vui lòng chọn thành phố theo cách thủ công",
        status: "error",
        duration: 2000,
        isClosable: true,
      });
          ...
          <Box py={4} px={2}>
            ...
            <HStack spacing={3}>
              <Input
                color={"#000"}
                size="md"
                placeholder="Tìm kiếm một vị trí"
                value={searchValue}
            ...
            {citiesLoading ? (
              ...
              <>
                ...
                >
                  {isLoading ? "Đang tải..." : "Sử dụng vị trí hiện tại"}
                </MenuItem>
