...
const Transection = () => {
  ...
  return (
    <Box px={1} maxH={{ base: "90vh", md: "40vh" }} overflow={"scroll"} mt={5}>
      <Heading fontSize={16}>Lịch sử giao dịch</Heading>
                ...
                <AccordionItem>
                        ...
                        >
                          ...
                          >
                            {tran?.notes || tran.transaction_type === "Credited"
                              ? "Số tiền được cộng vào ví của bạn"
                              : "Số tiền đã bị trừ khỏi ví của bạn"}
                          </Text>
                        </Text>
                        <Text
                          fontSize={12}
                  ...
                  <AccordionPanel pb={4}>
                    <Text mb={0} fontSize={14}>
                      Mã giao dịch : {tran.id}
                    </Text>
                    <Text mb={0} fontSize={14}>
                      Mã thanh toán : {tran.payment_transaction_id || "N/A"}
                    </Text>
                    <Text mb={0} fontSize={14}>
