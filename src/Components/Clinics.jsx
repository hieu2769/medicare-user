        ...
        {isLoading ? (
          ...
          <>
            <VStack spacing={4} mb={10}>
              ...
              >
                {selectedCity
                  ? `Các phòng khám hàng đầu tại ${selectedCity.city}`
              ...
              <Text
                ...
                mx="auto"
              >
                Khám phá các dịch vụ chăm sóc sức khỏe chuyên biệt phù hợp với nhu cầu của bạn,
                    ...
                    >
                      ...
                      <VStack p={5} align="start">
                        ...
                        <Text
                          ...
                          mb={0}
                        >
                          {item.address || "Địa chỉ không được chỉ định"}
                        </Text>
                        {item.city_title && (
                          <Text
                            mt={-1}
